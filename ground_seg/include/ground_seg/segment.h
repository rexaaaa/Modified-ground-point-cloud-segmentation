#ifndef GROUND_SEG_SEGMENT_H_
#define GROUND_SEG_SEGMENT_H_

#include <list>
#include <map>
#include <float.h>
#include "ground_seg/bin.h"
...
public:
  ...
  std::pair<double,bool> verticalDistanceToLine(const double& d, const double &z);
